...
// image upload
Route::post('employees/add-image/{id}','UserController@addImage');

// comment
Route::post('employee/comment/{id}','EmployeeController@comment');
...
//rename departments to company
Route::get('company','DepartmentController@departments');
...
Route::get('customers/delete/{id}','CustomerController@deleteCustomer');
...
Route::get('employees/import','EmployeeController@importEmployee');
Route::post('employees/import','EmployeeController@importCSVEmployee');
Route::post('employees/add-normal-employee-post','EmployeeController@addNormalEmployeePost');
Route::get('employees/edit-normal/{id}','EmployeeController@editNormalEmployee');
Route::post('employees/edit-normal/{id}','EmployeeController@updateNormalEmployee');
Route::get('employees/delete-normal-employee/{id}','EmployeeController@deleteNormalEmployee');
...
Route::get('employees/editcoverletterpdf/{id}','EmployeeController@editcoverletterpdf');
Route::post('/employees/editcoverletterpdf/update','EmployeeController@editcoverletterpdfUpdate');

Route::get('employees/editvisaform/{id}','EmployeeController@editvisaform');
Route::post('/employee/editvisaform/update','EmployeeController@editvisaformUpdate');

Route::post('employees/generatevisaform','EmployeeController@generatevisaform');
Route::get('employees/editburform/{id}','EmployeeController@editburform');
Route::post('employees/generateburform','EmployeeController@generateburform');

Route::get('employees/editcoverform/{id}','EmployeeController@editcoverform');
Route::post('employees/generatecoverform','EmployeeController@generatecoverform');


Route::get('employees/editcancellationform/{id}','EmployeeController@editcancellationform');
Route::post('employees/generatecancellationform','EmployeeController@generatecancellationform');


Route::get('employees/print-pdf', 'EmployeeController@printpdf');
...
Route::get('employees/burEmployeeTemplate/{id}','EmployeeController@BurEmployeeTemplate');

Route::post('employee/add-image/{id}','EmployeeController@addImage');
Route::post('employee/status/{id}','EmployeeController@status');

Route::post('employees/threecheck','EmployeeController@threecheck');
Route::post('employees/jobcenter1','EmployeeController@jobcenter1');
Route::post('employees/ldsubmission','EmployeeController@ldsubmission');
Route::post('employees/visasubmission','EmployeeController@visasubmission');
Route::post('employees/arrival','EmployeeController@arrival');
Route::post('employees/cancellation','EmployeeController@cancellation');
Route::post('employees/cont','EmployeeController@cont');

Route::post('employees/filter_by_passport_exp','EmployeeController@filterSearchEmployeeByPassportExp')->name('filter_by_passport_exp');
...
// visa submission
Route::post('employees/jobcenter','EmployeeController@jobcenter');
...
Route::get('employees/view/{id}','EmployeeController@viewEmployee');
Route::get('employees/downloadcover/{id}',function(){
	// return "welcome";
	 return \File::get(public_path() . '/htmltopdf.php');
